...
const dbConfig = {
    ...
    database: process.env.DB_NAME || 'submarine_faqs',
    charset: 'utf8mb4',
    timezone: '+00:00',
...
// For Vercel deployment with PlanetScale or similar
if (process.env.DATABASE_URL) {
    // Parse database URL for services like PlanetScale
...
export class FAQDatabase {
    ...
    static async searchFAQs(searchTerm) {
        ...
        return await query(sql, [searchTerm, searchTerm, searchPattern, searchPattern]);
    }
